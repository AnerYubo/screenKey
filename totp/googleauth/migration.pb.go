...
const (
	MigrationPayload_DIGIT_COUNT_INVALID MigrationPayload_DigitCount = 0
...
type MigrationPayload_OTPParameters struct {
	...
	Digits        MigrationPayload_DigitCount `protobuf:"varint,5,opt,name=digits,proto3,enum=googleauth.MigrationPayload_DigitCount" json:"digits,omitempty"`
...
func (x *MigrationPayload_OTPParameters) GetDigits() MigrationPayload_DigitCount {
	...
	return MigrationPayload_DIGIT_COUNT_INVALID
}
...
const file_migration_proto_rawDesc = "" +
	"\n" +
	"\x0fmigration.proto\x12\n" +
	"googleauth\"\xc0\x05\n" +
	"\x10MigrationPayload\x12Q\n" +
	"\x0eotp_parameters\x18\x01 \x03(\v2*.googleauth.MigrationPayload.OTPParametersR\rotpParameters\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x05R\aversion\x12\x1d\n" +
	"\n" +
	"batch_size\x18\x03 \x01(\x05R\tbatchSize\x12\x1f\n" +
	"\vbatch_index\x18\x04 \x01(\x05R\n" +
	"batchIndex\x12\x19\n" +
	"\bbatch_id\x18\x05 \x01(\x05R\abatchId\x1a\xae\x02\n" +
	"\rOTPParameters\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\fR\x06secret\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06issuer\x18\x03 \x01(\tR\x06issuer\x12D\n" +
	"\talgorithm\x18\x04 \x01(\x0e2&.googleauth.MigrationPayload.AlgorithmR\talgorithm\x12?\n" +
	"\x06digits\x18\x05 \x01(\x0e2'.googleauth.MigrationPayload.DigitCountR\x06digits\x128\n" +
	"\x04type\x18\x06 \x01(\x0e2$.googleauth.MigrationPayload.OtpTypeR\x04type\x12\x18\n" +
	"\acounter\x18\a \x01(\x03R\acounter\"H\n" +
	"\tAlgorithm\x12\x10\n" +
	"\fALGO_INVALID\x10\x00\x12\b\n" +
	"\x04SHA1\x10\x01\x12\n" +
	"\n" +
	...
	"\x03MD5\x10\x04\".\n" +
	"\aOtpType\x12\x0f\n" +
	"\vOTP_INVALID\x10\x00\x12\b\n" +
	"\x04HOTP\x10\x01\x12\b\n" +
	"\x04TOTP\x10\x02\"9\n" +
	"\n" +
	"DigitCount\x12\x17\n" +
	"\x13DIGIT_COUNT_INVALID\x10\x00\x12\a\n" +
	"\x03SIX\x10\x01\x12\t\n" +
	"\x05EIGHT\x10\x02B\x19Z\x17./googleauth;googleauthb\x06proto3"
...
var file_migration_proto_goTypes = []any{
	(MigrationPayload_Algorithm)(0),        // 0: googleauth.MigrationPayload.Algorithm
	(MigrationPayload_OtpType)(0),          // 1: googleauth.MigrationPayload.OtpType
	(MigrationPayload_DigitCount)(0),       // 2: googleauth.MigrationPayload.DigitCount
	(*MigrationPayload)(nil),               // 3: googleauth.MigrationPayload
	(*MigrationPayload_OTPParameters)(nil), // 4: googleauth.MigrationPayload.OTPParameters
}
var file_migration_proto_depIdxs = []int32{
	4, // 0: googleauth.MigrationPayload.otp_parameters:type_name -> googleauth.MigrationPayload.OTPParameters
	0, // 1: googleauth.MigrationPayload.OTPParameters.algorithm:type_name -> googleauth.MigrationPayload.Algorithm
	2, // 2: googleauth.MigrationPayload.OTPParameters.digits:type_name -> googleauth.MigrationPayload.DigitCount
	1, // 3: googleauth.MigrationPayload.OTPParameters.type:type_name -> googleauth.MigrationPayload.OtpType
